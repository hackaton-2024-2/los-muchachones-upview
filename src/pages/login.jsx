      ...
      <div className="relative flex flex-col md:flex-row items-center justify-center w-full max-w-5xl p-6">
        ...
        <div className="bg-gray-800 rounded-2xl p-8 md:w-1/2 w-full max-w-md z-10 shadow-lg">
          ...
          <form className="flex flex-col space-y-4">
            ...
            <button className="w-full py-2 mt-4 bg-cyan-500 text-white font-semibold rounded-md hover:bg-cyan-600 transition duration-200" onClick={() => setIsLoggedIn(true)}>
              Iniciar Sesión
            </button>
          </form>
        ...
        <div className="hidden md:block md:w-1/2">
          <img src="/assets/Background2tree.png" alt="Decoración de árboles" className="w-full h-auto" />
        </div>
      </div>
    </div>
  );
